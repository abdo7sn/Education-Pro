 ...
 * @since 1.0.0
 */
class Education_Footer_Widgets {
     ...
     * @var int
     */
    protected $theme_prefix = 'education';
    ...
    function footer_widgets_init() {
        ...
        for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
            register_sidebar( array(
                'name'          => sprintf( __( 'Footer Widget %d', 'education' ), $i ),
    ...
    private function get_number_of_active_widgets() {
        ...
        $count = 0;
		error_log('footer_widgets_init called');
        for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
    ...
    function add_footer_widgets() {
        ...
        $args = array(
        'container' => 'main',
        'before'    => '<main class="tm-main"><footer class="row tm-row">',
        'after'     => '</main></footer>',
        );
...
// Initialize.
$Education_Footer_Widgets = new Education_Footer_Widgets();
