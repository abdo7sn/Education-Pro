 ...
 */
class Education_Dropdown_Taxonomies_Control extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$choices = array();
		$choices[0] = esc_html__( '&mdash; Select &mdash;', 'education' );
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'education-customize-controls' );
		wp_enqueue_script( 'education-customize-controls' );
 ...
 * @see WP_Customize_Control
 */
class Education_Section_Manager_Control extends WP_Customize_Control {
	/**
	 * Control type.
	 *
	 * @access public
